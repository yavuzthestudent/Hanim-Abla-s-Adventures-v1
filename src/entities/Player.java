...
public class Player extends Entity {
	...
	private void initAttackBox() {
		...
		attackBox = new Rectangle2D.Float(x, y, (int) (35 * Game.SCALE), (int) (20 * Game.SCALE)); // değiştirildi
	}
	...
	private void checkAttack() {
		...
		if (attackChecked || aniIndex != 5) // ana karakterin saldırı çiziminin olduğu index DEĞİŞTİRİLDİ
			return;
		attackChecked = true;
	...
	private void updateAttackBox() {
		if (right) {
			attackBox.x = hitbox.x + hitbox.width - (int) (Game.SCALE * 4); // değiştirildi

		} else if (left) {
			attackBox.x = hitbox.x - hitbox.width - (int) (Game.SCALE * 14.5); // değiştirildi
	...
	private void updatePos() {
		...
		if (left) {
			xSpeed -= walkSpeed;
			flipX = (int) (width - xDrawOffset); // değiştirildi
			flipW = -1;
		}
